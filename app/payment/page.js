                    ...
                    <div className="w-full max-w-full px-3 flex-0">
                        <div
                            ...
                            <div className="overflow-x-auto">
                                <table className="table table-flush" datatable id="datatable-search-list">
                                        ...
                                        <td className="font-semibold leading-tight text-xs">
                                            <div className="flex items-center">
                                                <button
                                                    ...
                                                    <i className="fas fa-undo text-3xs" aria-hidden="true"></i></button>
                                                <span>Refunded</span>
                                            </div>
                                        </td>
                                        <td className="font-semibold leading-tight text-xs">
                                        ...
                                        <td>
                                            <div className="flex items-center">
                                                <div className="min-h-6 pl-7 mb-0.5 block">
                                                    <input
                                                        className="w-5 h-5 ease-soft -ml-7 rounded-1.4 checked:bg-gradient-to-tl checked:from-gray-900 checked:to-slate-800 after:text-xxs after:font-awesome after:duration-250 after:ease-soft-in-out duration-250 relative float-left mt-1 cursor-pointer appearance-none border border-solid border-slate-150 bg-white bg-contain bg-center bg-no-repeat align-top transition-all after:absolute after:flex after:h-full after:w-full after:items-center after:justify-center after:text-white after:opacity-0 after:transition-all after:content-['\f00c'] checked:border-0 checked:border-transparent checked:bg-transparent checked:after:opacity-100"
                                                        type="checkbox" id="customCheck11"/>
                                                </div>
                                                <p className="mb-0 ml-2 font-semibold leading-tight text-xs">#10431</p>
                                            </div>
                                        </td>
                                        <td className="font-semibold">
                                            <span className="my-2 leading-tight text-xs">2 Nov, 3:12 PM</span>
                                        </td>
                                        <td className="font-semibold leading-tight text-xs">
                                            <div className="flex items-center">
                                                <button
                        ...
                        <span className="my-2 leading-tight text-xs">
                          Kitchen Gadgets
                                        ...
                                        <td className="font-semibold leading-tight text-xs">
                                            <span className="my-2 leading-tight text-xs">$164,90</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div className="flex items-center">
                                                <div className="min-h-6 pl-7 mb-0.5 block">
                                                    <input
                                                        className="w-5 h-5 ease-soft -ml-7 rounded-1.4 checked:bg-gradient-to-tl checked:from-gray-900 checked:to-slate-800 after:text-xxs after:font-awesome after:duration-250 after:ease-soft-in-out duration-250 relative float-left mt-1 cursor-pointer appearance-none border border-solid border-slate-150 bg-white bg-contain bg-center bg-no-repeat align-top transition-all after:absolute after:flex after:h-full after:w-full after:items-center after:justify-center after:text-white after:opacity-0 after:transition-all after:content-['\f00c'] checked:border-0 checked:border-transparent checked:bg-transparent checked:after:opacity-100"
                                                        type="checkbox" id="customCheck12"/>
                                                </div>
                                                <p className="mb-0 ml-2 font-semibold leading-tight text-xs">#10432</p>
                                            </div>
                                        </td>
                                        <td className="font-semibold">
                                            <span className="my-2 leading-tight text-xs">2 Nov, 5:12 PM</span>
                                        </td>
                                        <td className="font-semibold leading-tight text-xs">
                                            <div className="flex items-center">
                                                <button
                                        ...
                                        <td className="font-semibold leading-tight text-xs">
                                            <div className="flex items-center">
                                                <div
                                                    className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white transition-all duration-200 text-xs ease-soft-in-out rounded-xl bg-gradient-to-tl from-blue-600 to-cyan-400">
                                                    <span>O</span>
                                                </div>
                        ...
                        <span className="my-2 leading-tight text-xs">
                          Office Papers
                                        ...
                                        <td className="font-semibold leading-tight text-xs">
                                            <span className="my-2 leading-tight text-xs">$23,90</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
